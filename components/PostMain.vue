<template>
    <div id="post-main" class="flex border-b py-6">
        ...
        <div class="pl-3 w-full px-4">
            ...
            <div class="mt-2.5 flex">
                <div class="relative min-h-[480px] max-h-[260px] flex items-center bg-black rounded-xl cursor-pointer">
                    <video
                        ref="video"
                        loop
                        muted
                ...
                <div class="relative mr-[75px]">
                    <div class="absolute bottom-0 pl-2">
                        <div class="pb-4 text-center">
                            ...
                            <span class="text-xs text-gray-800 font-semibold" >523K</span>
                        </div>
                        <div class="pb-4 text-center">
                            <button class="rounded-full bg-gray-200 p-2 cursor-pointer">
                                <Icon name="bx:bxs-message-rounded-dots" size="25" />
                            </button>
                            <span class="text-xs text-gray-800 font-semibold" >24K</span>
                        </div>
                        <div class="pb-4 text-center">
                            <button class="rounded-full bg-gray-200 p-2 cursor-pointer">
                                <Icon name="ri:share-forward-fill" size="25" />
                            </button>
                            <span class="text-xs text-gray-800 font-semibold" >10K</span>
                        </div>
                    </div>
                </div>
            </div>
