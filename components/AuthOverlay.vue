<template>
    ...
    >
        <div class="relative bg-white w-full max-w-[470px] h-[75%] p-4 rounded-lg">
            ...
            <div class="absolute flex items-center justify-center py-5 left-0 bottom-0 border-t w-full">
                <span class="text-[14px] text-gray-600">{{ isRegister ? "Don't have an account?" : "Do you already have an account?" }}</span>
                <button
