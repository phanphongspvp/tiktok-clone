<template>
    <div id="top-nav" class="fixed bg- z-30 flex items-center w-full border-b h-[61px] bg-white">
        <div :class="route.fullPath === '/' ? 'max-w-[1150px]' : ''" class="flex items-center justify-between w-full px-6 mx-auto">
            ...
            <div class="hidden md:flex items-center bg-[#F1F1F2] p-1 rounded-full max-w-[300px] w-full">
                <input 
                    type="text"
            ...
            <div class="flex items-center justify-end gap-3 min-w-[320px] w-full">
                <NuxtLink to="/upload" class="flex items-center border rounded-md px-3 py-[6px] hover:bg-gray-100">
                ...
                <div class="flex items-center">
                    ...
                    <div class="relative">
                        ...
                        <div v-if="showMenu" id="popup-menu" class="absolute bg-white rounded-lg py-1.5 w-[200px] shadow-xl top-[43px] -right-2">
                            <NuxtLink
